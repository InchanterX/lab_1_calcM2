...
def test_number_and_operations():
    ...
    assert [tok.type for tok in tokens] == [
        "NUMBER", "OPERATIONS", "NUMBER", "OPERATIONS", "NUMBER"]
...
def test_brackets():
    ...
    expression = "(2+2)*2"
    tokens = t.tokenize(expression)
    assert [tok.type for tok in tokens] == ["LBRACKET", "NUMBER",
                                            "OPERATIONS", "NUMBER", "RBRACKET", "OPERATIONS", "NUMBER"]
...
def test_extra_spaces():
    ...
    tokens = t.tokenize(expression)
    assert [tok.type for tok in tokens] == ["NUMBER", "OPERATIONS",
                                            "NUMBER", "OPERATIONS", "NUMBER", "OPERATIONS", "NUMBER"]
...
def test_potentially_incorrect_expression():
    ...
    tokens = t.tokenize(expression)
    assert [tok.type for tok in tokens] == [
        "NUMBER", "OPERATIONS", "OPERATIONS", "NUMBER", "OPERATIONS"]
